              ...
              <table className='tabla-empleados'>
                <thead>
                  <tr>
                    ...
                    <th>NOMBRES</th>
                    <th>APELLIDOS</th>
                    <th>BONO POR DESEMPEÑO</th>
                    <th>PAGO DE UTILIDADES</th>
                    <th>MOVILIDAD</th>
                    <th>PAGO POR SUPLENCIA</th>
                    <th>PAGO ESPECIALES</th>
                    <th>CTS</th>
                    <th>AFP</th>
                    <th>SUELDO</th>
                    <th>MONTO</th>
                  ...
                  {data.slice(0, 4).map((empleado) => {
                    ...
                    return (
                      <tr key={empleado.dni}>
                        ...
                        <td>{empleado.bono_desempeno}</td>
                        <td>{empleado.pago_utilidades}</td>
                        <td>{empleado.movilidad}</td>
                        <td>{empleado.pago_suplencia}</td>
                        <td>{empleado.pago_especiales}</td>
                        <td>{empleado.cts}</td>
                        <td>{empleado.afp}</td>
